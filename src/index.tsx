...
import { CoundownWidgetProps, CoundownWidget } from "./coundown-widget";
...
const factory: BlockFactory = (BaseBlockClass, _widgetApi) => {
  /**
   *  <coundown-widget message="world!"></coundown-widget>
   */
  return class CoundownWidgetBlock extends BaseBlockClass implements BaseBlock {
    public constructor() {
      super();
    }

    private get props(): CoundownWidgetProps {
      const attrs = this.parseAttributes<CoundownWidgetProps>();
      return {
        ...attrs,
    ...
    public renderBlock(container: HTMLElement): void {
      ReactDOM.render(<CoundownWidget {...this.props} />, container);
    }
