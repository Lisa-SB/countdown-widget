 ...
 * React Component
 */
export interface CoundownWidgetProps extends BlockAttributes {
  enddate: string;
}

const calculatedifference = (startdate: number, final: string) => {
...
export const CoundownWidget = ({ enddate }: CoundownWidgetProps): ReactElement => {
